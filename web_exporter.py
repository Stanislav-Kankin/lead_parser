    ...
    for item in items:
        ws.append(
            [
                ...
                _site_url(item),
                item.company_phone or item.focus_phone or "",
                item.company_email or item.focus_email or "",
                item.company_inn or "",
                ...
                item.focus_registration_date or "",
                item.focus_msp or "",
