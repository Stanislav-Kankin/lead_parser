...
TELEGRAM_SIGNAL_REQUIRED_COLUMNS = {
    ...
    "next_question": "ALTER TABLE telegram_signals ADD COLUMN next_question TEXT",
    "reply_tone": "ALTER TABLE telegram_signals ADD COLUMN reply_tone VARCHAR",
...
REQUIRED_COLUMNS = {
    ...
    "focus_revenue": "ALTER TABLE leads ADD COLUMN focus_revenue VARCHAR",
    "focus_balance": "ALTER TABLE leads ADD COLUMN focus_balance VARCHAR",
    "focus_profit": "ALTER TABLE leads ADD COLUMN focus_profit VARCHAR",
    ...
    "focus_email": "ALTER TABLE leads ADD COLUMN focus_email TEXT",
    "focus_website": "ALTER TABLE leads ADD COLUMN focus_website VARCHAR",
    "focus_registration_date": "ALTER TABLE leads ADD COLUMN focus_registration_date VARCHAR",
...
SOCIAL_LEAD_REQUIRED_COLUMNS = {
    ...
    "focus_loaded_at": "ALTER TABLE social_leads ADD COLUMN focus_loaded_at DATETIME",
    "focus_legal_name": "ALTER TABLE social_leads ADD COLUMN focus_legal_name VARCHAR",
    "focus_status": "ALTER TABLE social_leads ADD COLUMN focus_status VARCHAR",
    "focus_region": "ALTER TABLE social_leads ADD COLUMN focus_region VARCHAR",
    "focus_address": "ALTER TABLE social_leads ADD COLUMN focus_address VARCHAR",
    "focus_revenue": "ALTER TABLE social_leads ADD COLUMN focus_revenue VARCHAR",
    "focus_balance": "ALTER TABLE social_leads ADD COLUMN focus_balance VARCHAR",
    "focus_profit": "ALTER TABLE social_leads ADD COLUMN focus_profit VARCHAR",
    "focus_arbitration": "ALTER TABLE social_leads ADD COLUMN focus_arbitration VARCHAR",
    "focus_employees": "ALTER TABLE social_leads ADD COLUMN focus_employees VARCHAR",
    "focus_okved": "ALTER TABLE social_leads ADD COLUMN focus_okved VARCHAR",
    "focus_other_okved": "ALTER TABLE social_leads ADD COLUMN focus_other_okved TEXT",
    "focus_director": "ALTER TABLE social_leads ADD COLUMN focus_director VARCHAR",
    "focus_msp": "ALTER TABLE social_leads ADD COLUMN focus_msp VARCHAR",
    "focus_phone": "ALTER TABLE social_leads ADD COLUMN focus_phone TEXT",
    "focus_email": "ALTER TABLE social_leads ADD COLUMN focus_email TEXT",
    "focus_website": "ALTER TABLE social_leads ADD COLUMN focus_website VARCHAR",
    "focus_registration_date": "ALTER TABLE social_leads ADD COLUMN focus_registration_date VARCHAR",
